...
export default function CourseSidebar() {
  ...
  return (
    <aside className="w-[250px] bg-[#262626] border-r border-dark-border flex flex-col h-screen fixed left-0 top-0 z-10">
      {/* Logo */}
      ...
      <div className="px-4 py-4">
        <div className="relative">
          ...
          <Input
            ...
            className="w-full bg-dark-bg border-dark-border rounded-lg pl-10 pr-12 py-2 font-satoshi text-sm text-[#a3a3a3] focus:outline-none focus:ring-2 focus:ring-purple-accent focus:border-transparent"
          />
          <div className="absolute right-3 top-2.5 flex items-center bg-gray-600 rounded px-1">
            <span className="text-xs text-gray-300 font-satoshi">⌘K</span>
          </div>
        </div>
      </div>
      {/* Navigation */}
      ...
      <div className="mt-auto">
        {/* Start Button */}
        <div className="p-4">
          <Button className="w-full bg-gray-700 hover:bg-gray-600 text-white font-satoshi text-[13px] leading-[20px] rounded-lg py-2 px-4 flex items-center justify-between">
        ...
        <div className="px-4 pb-4">
          <Button
            variant="ghost"
            className="w-full justify-start font-satoshi font-normal text-[13px] leading-[20px] text-[#a3a3a3] hover:text-white hover:bg-white/10"
          >
